...
class RobustVDN:
    ...
    def __init__(self, rho_value, device=None):
        ...
        self.training_params = get_training_params('vdn')
    ...
    def _update_networks(self):
        ...
        with torch.no_grad():
            ...
            target = reward_batch + self.network_params['gamma'] * (1 - self.rho_value) * global_next_max_q * (1 - done_batch)
    ...
    def train(self):
        ...
        pbar = tqdm(range(self.training_params['num_episodes']), 
                   desc=f'Training VDN (rho={self.rho_value})')
        for episode in pbar:
    ...
    def _save_results(self):
        ...
        results_dir = create_results_dir('vdn', self.rho_value)
        ...
        plt.xlabel('Episode')
        plt.ylabel('Reward')
        plt.title(f'Robust VDN Training Reward (rho={self.rho_value})')
        plt.legend()
